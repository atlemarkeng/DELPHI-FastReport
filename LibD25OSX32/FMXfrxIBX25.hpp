...
// (DO NOT EDIT: machine generated header) 'FMXfrxIBX25.dpk' rev: 32.00 (MacOS)

#ifndef Fmxfrxibx25HPP
#define Fmxfrxibx25HPP
...
#include <FMX.frxDBSet.hpp>	// (FMXfrxDB25)
#include <FMX.frxEditMD.hpp>	// (FMXfrxDB25)
...
#include <FMX.frxEditQueryParams.hpp>	// (FMXfrxDB25)
#include <FMX.fs_synmemo.hpp>	// (FMXfs25)
#include <FMX.frxEditSQL.hpp>	// (FMXfrxDB25)
...
#include <FMX.frxConnWizard.hpp>	// (FMXfrxDB25)
#include <FMX.frxCustomDBEditor.hpp>	// (FMXfrxDB25)
#include <FMX.fs_idbrtti.hpp>	// (FMXfsDB25)
#include <FMX.frxCustomDBRTTI.hpp>	// (FMXfrxDB25)
#include <FMX.frxCustomDB.hpp>	// (FMXfrxDB25)
...
#include <FMX.fs_iibxrtti.hpp>	// (FMXfsIBX25)
// SO_PFX: bpl
// PRG_EXT: .dylib
// OBJ_EXT: .o
...
namespace Fmxfrxibx25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfrxibx25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFRXIBX25)
using namespace Fmxfrxibx25;
#endif
#pragma pack(pop)
#pragma option pop
