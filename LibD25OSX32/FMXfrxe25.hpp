...
// (DO NOT EDIT: machine generated header) 'FMXfrxe25.dpk' rev: 32.00 (MacOS)
...
#include <FMX.frxChBoxRTTI.hpp>	// (FMXfrx25)
#include <FMX.frxChBox.hpp>	// (FMXfrx25)
// SO_PFX: bpl
// PRG_EXT: .dylib
// OBJ_EXT: .o
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFRXE25)
using namespace Fmxfrxe25;
#endif
#pragma pack(pop)
#pragma option pop
