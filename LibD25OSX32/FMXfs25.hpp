...
// (DO NOT EDIT: machine generated header) 'FMXfs25.dpk' rev: 32.00 (MacOS)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFS25)
using namespace Fmxfs25;
#endif
#pragma pack(pop)
#pragma option pop
