...
// (DO NOT EDIT: machine generated header) 'FMX.fs_iexpression.pas' rev: 32.00 (Windows)
...
public:
	...
	void __fastcall AddConstWithType(const System::Variant &AValue, Fmx::Fs_iinterpreter::TfsVarType aTyp);
