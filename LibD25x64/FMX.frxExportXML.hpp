...
// (DO NOT EDIT: machine generated header) 'FMX.frxExportXML.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxXMLExportDialog : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxXMLExportDialog(System::Classes::TComponent* AOwner) : Fmx::Frxbasemodalform::TfrxForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxXMLExportDialog(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
