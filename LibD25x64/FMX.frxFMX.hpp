...
// (DO NOT EDIT: machine generated header) 'FMX.frxFMX.pas' rev: 32.00 (Windows)
...
protected:
	...
	virtual bool __fastcall DoBeginScene(const Fmx::Graphics::PClipRects AClipRects = (Fmx::Graphics::PClipRects)(0x0), NativeUInt AContextHandle = (NativeUInt)(0ULL));
...
private:
	...
	System::UnicodeString __fastcall GetFontNameHash(Fmx::Graphics::TFont* const AFont, bool WordWrap, const Fmx::Graphics::TFillTextFlags Flags, const Fmx::Types::TTextAlign ATextAlign, const Fmx::Types::TTextAlign VTextAlign);
