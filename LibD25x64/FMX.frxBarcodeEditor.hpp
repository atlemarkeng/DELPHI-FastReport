...
// (DO NOT EDIT: machine generated header) 'FMX.frxBarcodeEditor.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxBarcodeEditorForm : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxBarcodeEditorForm(System::Classes::TComponent* AOwner) : Fmx::Frxbasemodalform::TfrxForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxBarcodeEditorForm(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
