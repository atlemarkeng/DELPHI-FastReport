...
// (DO NOT EDIT: machine generated header) 'FMXfsADO25.dpk' rev: 32.00 (Windows)

#ifndef Fmxfsado25HPP
#define Fmxfsado25HPP
...
namespace Fmxfsado25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfsado25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSADO25)
using namespace Fmxfsado25;
#endif
#pragma pack(pop)
#pragma option pop
