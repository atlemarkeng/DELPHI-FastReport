...
// (DO NOT EDIT: machine generated header) 'FMX.fs_iinterpreter.pas' rev: 32.00 (Windows)

#ifndef Fmx_Fs_iinterpreterHPP
#define Fmx_Fs_iinterpreterHPP
...
public:
	/* TObject.Create */ inline __fastcall TfsLocalVariablesHelper(void) : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TfsLocalVariablesHelper(void) { }
...
public:
	...
	int __fastcall SaveLocalVariables(void);
...
_DECLARE_METACLASS(System::TMetaClass, TfsEventClass);
...
private:
	...
	Fmx::Fs_xml::TfsXMLItem* FLateBindingXmlSource;
...
public:
	...
	__property Fmx::Fs_xml::TfsXMLItem* LateBindingXmlSource = {read=FLateBindingXmlSource, write=FLateBindingXmlSource};
};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FS_IINTERPRETER)
using namespace Fmx::Fs_iinterpreter;
#endif
