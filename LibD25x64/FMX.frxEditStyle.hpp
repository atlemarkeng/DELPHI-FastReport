...
// (DO NOT EDIT: machine generated header) 'FMX.frxEditStyle.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxStyleEditorForm : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxStyleEditorForm(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
