...
// (DO NOT EDIT: machine generated header) 'FMXfsDB25.dpk' rev: 32.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSDB25)
using namespace Fmxfsdb25;
#endif
#pragma pack(pop)
#pragma option pop
