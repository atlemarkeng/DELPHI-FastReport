...
// (DO NOT EDIT: machine generated header) 'FMX.frxChart.pas' rev: 32.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, TChartClass);
...
_DECLARE_METACLASS(System::TMetaClass, TSeriesClass);
