...
// (DO NOT EDIT: machine generated header) 'FMXfrxADO25.dpk' rev: 32.00 (Windows)

#ifndef Fmxfrxado25HPP
#define Fmxfrxado25HPP
...
#include <FMX.fs_iadortti.hpp>	// (FMXfsADO25)
// PRG_EXT: .bpl
// OBJ_EXT: .o

//-- user supplied -----------------------------------------------------------

namespace Fmxfrxado25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfrxado25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFRXADO25)
using namespace Fmxfrxado25;
#endif
#pragma pack(pop)
#pragma option pop
