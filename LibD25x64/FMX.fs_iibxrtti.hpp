...
// (DO NOT EDIT: machine generated header) 'FMX.fs_iibxrtti.pas' rev: 32.00 (Windows)

#ifndef Fmx_Fs_iibxrttiHPP
#define Fmx_Fs_iibxrttiHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FS_IIBXRTTI)
using namespace Fmx::Fs_iibxrtti;
#endif
