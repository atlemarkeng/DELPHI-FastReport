...
// (DO NOT EDIT: machine generated header) 'FMX.frxExportPDF.pas' rev: 32.00 (Windows)
...
class PASCALIMPLEMENTATION TfrxPDFExportDialog : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxPDFExportDialog(System::Classes::TComponent* AOwner) : Fmx::Frxbasemodalform::TfrxForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxPDFExportDialog(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
...
private:
	...
	System::UnicodeString FSubstituteName;
