...
// (DO NOT EDIT: machine generated header) 'FMX.frxExportHTML.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxHTMLExportDialog : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxHTMLExportDialog(System::Classes::TComponent* AOwner) : Fmx::Frxbasemodalform::TfrxForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxHTMLExportDialog(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
