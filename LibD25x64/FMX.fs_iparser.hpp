...
// (DO NOT EDIT: machine generated header) 'FMX.fs_iparser.pas' rev: 32.00 (Windows)

#ifndef Fmx_Fs_iparserHPP
#define Fmx_Fs_iparserHPP
...
public:
	...
	int __fastcall GetPlainPosition(System::Types::TPoint pt);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FS_IPARSER)
using namespace Fmx::Fs_iparser;
#endif
