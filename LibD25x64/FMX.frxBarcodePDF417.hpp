...
// (DO NOT EDIT: machine generated header) 'FMX.frxBarcodePDF417.pas' rev: 32.00 (Windows)
...
private:
	...
	System::TArray__1<System::Byte> bytes;
	double FAspectRatio;
	int FCodePage;
	int bitPtr;
	int cwPtr;
	...
	int __fastcall GetTextTypeAndValue(System::TArray__1<System::Byte> &input, int maxLength, int idx)/* overload */;
	int __fastcall GetTextTypeAndValue(int maxLength, int idx)/* overload */;
	void __fastcall TextCompaction(System::TArray__1<System::Byte> &input, int start, int length)/* overload */;
	...
	void __fastcall BasicNumberCompaction(System::TArray__1<System::Byte> &input, int start, int length)/* overload */;
	void __fastcall NumberCompaction(System::TArray__1<System::Byte> &input, int start, int length)/* overload */;
