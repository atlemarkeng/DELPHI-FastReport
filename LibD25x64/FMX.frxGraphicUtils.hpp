...
// (DO NOT EDIT: machine generated header) 'FMX.frxGraphicUtils.pas' rev: 32.00 (Windows)
...
public:
	...
	__property float SymbolWidth = {read=FSymbolWidth};
};
