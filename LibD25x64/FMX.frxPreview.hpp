...
// (DO NOT EDIT: machine generated header) 'FMX.frxPreview.pas' rev: 32.00 (Windows)
...
public:
	...
	virtual void __fastcall ClearBackBuffer(void);
...
class PASCALIMPLEMENTATION TfrxPreviewForm : public Fmx::Frxbasemodalform::TfrxForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxPreviewForm(System::Classes::TComponent* AOwner) : Fmx::Frxbasemodalform::TfrxForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxPreviewForm(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Frxbasemodalform::TfrxForm(AOwner, Dummy) { }
...
private:
	...
	System::Types::TPoint FOldOffset;
	...
	double FZoom;
	bool FRTLLanguage;
	Fmx::Graphics::TBitmap* FDrawBuffer;
	Fmx::Graphics::TBitmap* FDrawBuffer2;
	bool FNeedBufferClear;
	bool FDoubleBuffered;
	Fmx::Frxfmx::TfrxFastCanvasLayer* FFastCanvas;
	bool FDoDblClick;
	Fmx::Types::TFmxObject* FParentForm;
	void __fastcall DrawPages(bool BorderOnly, Fmx::Graphics::TCanvas* DrawCanvas, const System::Types::TRectF &ARect);
	...
	HIDESBASE void __fastcall SetLocked(const bool Value);
...
public:
	...
	HIDESBASE void __fastcall SetPosition(int PageN, int Top);
	int __fastcall GetTopPosition(void);
	void __fastcall ClearBackBuffer(void);
