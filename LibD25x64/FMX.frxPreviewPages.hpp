...
// (DO NOT EDIT: machine generated header) 'FMX.frxPreviewPages.pas' rev: 32.00 (Windows)
...
private:
	...
	Fmx::Frxxmlserializer::TfrxXMLSerializer* FSerializer;
	Fmx::Graphics::TCanvas* FFastCanvas;
	Fmx::Frxfmx::TfrxFastCanvasLayer* FFastPrintCanvas;
	...
	void __fastcall DrawPageInternal(int Index, Fmx::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, System::Extended OffsetX, System::Extended OffsetY, const System::Types::TRectF &WorkArea);
...
public:
	...
	virtual void __fastcall DrawPage(int Index, Fmx::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, System::Extended OffsetX, System::Extended OffsetY, const System::Types::TRectF &WorkArea);
