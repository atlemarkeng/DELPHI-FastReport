...
unit FMX.frxBarcodePDF417;


interface

uses System.SysUtils, System.Types, System.UITypes, System.StrUtils, System.Classes,
      FMX.Types, FMX.Objects, FMX.Controls, FMX.Forms, FMX.Dialogs,
      System.Generics.Collections, FMX.frxBarcode2DBase, FMX.frxPrinter
{$IFDEF DELPHI19}
  , FMX.Graphics
{$ENDIF};
  ...
  /// </example>
    TfrxBarcodePDF417 = class(TfrxBarcode2DBase)
     ...
     private
        ...
        function GetTextTypeAndValue( var input : TBytes; maxLength, idx : integer ) : integer; overload;
        function GetTextTypeAndValue(maxLength, idx : integer) : integer; overload;
        procedure TextCompaction(var input : TBytes; start, length : integer); overload;
        procedure TextCompaction( start, length : integer); overload;
        procedure BasicNumberCompaction( start, length : integer);  overload;
        procedure BasicNumberCompaction(var input : TBytes; start, length : integer); overload;
        procedure NumberCompaction(var input : TBytes; start,length : integer); overload;
...
procedure TfrxBarcodePDF417.SetAspectRatio(v : Double);
begin
...
function TfrxBarcodePDF417.CalcBounds : TSize;
var
    textAdd : integer;
begin
      if ( ShowText ) then textAdd := 18 else textAdd := 0;
      result.width := FWidth * PixelWidth;
      result.height := FHeight * PixelHeight + textAdd;
end;
...
procedure TfrxBarcodePDF417.NumberCompaction(var input : TBytes; start,length : integer);
var
    full, size, k : integer;
begin
...
procedure TfrxBarcodePDF417.BasicNumberCompaction(var input : TBytes; start, length : integer);
var
...
procedure TfrxBarcodePDF417.TextCompaction(var input : TBytes; start, length : integer);
var
    dest : TInt;
...
function TfrxBarcodePDF417.GetTextTypeAndValue( var input : TBytes; maxLength, idx : integer ) : integer;
var
    c : char;
    ms,ps : integer;
begin
...
//16bfbc33f73bd4cb8424198d249c56b6