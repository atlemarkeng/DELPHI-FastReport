...
uses
  Winapi.Windows, System.Classes, System.SysUtils, FMX.Forms, FMX.frxADOComponents, FMX.frxCustomDB,
  FMX.frxDsgnIntf, FMX.frxRes, Data.DB, Data.Win.ADODB, Winapi.ADOInt, System.Variants, FMX.Platform.Win;
...
begin
  ...
  db.Connected := False;
  //FmxHandleToHWND(Application.MainForm.Handle)
  fName := PromptDataSource(0, db.ConnectionString);
  Result := fName <> '';
  if Result then
