...
type // Nested Types
  EInvalidTTFFormat = class(Exception);
...
{$WARNINGS OFF}
    ...
    Substitutes  : array  [1..Elements] of AnsiString = (
      #$EF#$BC#$AD#$EF#$BC#$B3#$20#$E3#$82#$B4#$E3#$82#$B7#$E3#$83#$83#$E3#$82#$AF,        'MS Gothic',
      #$EF#$BC#$AD#$EF#$BC#$B3#$20#$EF#$BC#$B0#$E3#$82#$B4#$E3#$82#$B7#$E3#$83#$83#$E3#$82#$AF,     'MS PGothic',
      #$EF#$BC#$AD#$EF#$BC#$B3#$20#$E6#$98#$8E#$E6#$9C#$9D,              'MS Mincho',
      #$EF#$BC#$AD#$EF#$BC#$B3#$20#$EF#$BC#$B0#$E6#$98#$8E#$E6#$9C#$9D,           'MS PMincho',
...
begin
  for i := 0 to fonts_collection.Count - 1 do
    TObject(fonts_collection[i]).Free;
...
function TrueTypeCollection.get_FontCollection: TFontCollection;
  ...
  begin
    if (FD[0] = AnsiChar(0)) and (FD[1] = AnsiChar(1)) and (FD[2] = AnsiChar(0)) and (FD[3] = AnsiChar(0)) then
      ...
      raise EInvalidTTFFormat.Create('TrueType font format error');
