...
's Name="8987" Text="Center window"/><StrRes Name="8988" Text="Print scaling"/><StrRes Name="8989" Text="Confirmation Reading"/><StrRes Name="9000" Tex' + 
't="Rows count:"/><StrRes Name="9001" Text="Split To Sheet"/><StrRes Name="9002" Text="Don''t split"/><StrRes Name="9003" Text="Use report pages"/><StrR' + 
'es Name="9004" Text="Use print on parent"/><StrRes Name="9101" Text="Export to DBF"/><StrRes Name="9102" Text="dBase (DBF) export"/><StrRes Name="9103' + 
'" Text=".dbf"/><StrRes Name="9104" Text="Failed to load the file"/><StrRes Name="9105" Text="Failure"/><StrRes Name="9106" Text="Field names"/><StrRes' + 
' Name="9107" Text="Automatically"/><StrRes Name="9108" Text="Manually"/><StrRes Name="9109" Text="Load from file"/><StrRes Name="9110" Text="Text file' + 
's (*.txt)|*.txt|All files|*.*"/><StrRes Name="9111" Text="DBF files (*.dbf)|*.dbf|All files|*.*"/><StrRes Name="9151" Text="Excel 97/2000/XP file"/><S' + 
'trRes Name="9152" Text="Auto create file"/><StrRes Name="9153" Text="Options"/><StrRes Name="9154" Text="Page"/><StrRes Name="9155" Text="Grid Lines"/' + 
...
' Text="Chunks. Each chunk has (rows):"/><StrRes Name="9160" Text="Chunk size must be a non negative integer value."/><StrRes Name="9161" Text="SingleS' + 
'heet must be False when exporting to chunks"/><StrRes Name="9162" Text="Author"/><StrRes Name="9163" Text="Comment"/><StrRes Name="9164" Text="Keyword' + 
's"/><StrRes Name="9165" Text="Revision"/><StrRes Name="9166" Text="Version"/><StrRes Name="9167" Text="Application"/><StrRes Name="9168" Text="Subject' + 
'"/><StrRes Name="9169" Text="Category"/><StrRes Name="9170" Text="Company"/><StrRes Name="9171" Text="Title"/><StrRes Name="9172" Text="Manager"/><Str' + 
'Res Name="9173" Text="General"/><StrRes Name="9174" Text="Information"/><StrRes Name="9175" Text="Protection"/><StrRes Name="9176" Text="Password"/><S' + 
'trRes Name="9177" Text="If you set a non empty password string, the generated document will be protected with this password. The password is always wr' + 
'itten in Unicode characters and must be shorter than 256 Unicode characters."/><StrRes Name="9178" Text="Confirmation"/><StrRes Name="9179" Text="Pass' + 
'word confirmation does not match the password. Type the password again."/><StrRes Name="9180" Text="Attempting to set a password of %d characters. The' + 
' maximum allowed length of a password is %d characters."/><StrRes Name="9181" Text="Adjust page size"/><StrRes Name="9200" Text="Microsoft Excel 2007 ' + 
'XML"/><StrRes Name="9201" Text="Microsoft PowerPoint 2007 XML"/></Resources>' + 
' ';
