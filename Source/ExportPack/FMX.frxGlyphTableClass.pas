...
unit FMX.frxGlyphTableClass;
{$HINTS OFF}
interface uses FMX.TTFHelpers, System.Classes, FMX.frxTrueTypeTable;
    ...
    type // Nested Types
        ...
        CompositeGlyphHeader = packed record
            public flags: Word;
            public glyphIndex: Word;
        end;
        GlyphHeader = packed record
            public numberOfContours: Smallint;
        ...
        GlyphTableClass = class(TrueTypeTable)
          strict private glyph_table_ptr: Pointer;
    ...
    end;
{
    ...
    begin
        ...
        begin
            ...
            if ((cgh.flags and $100) <> 0) then
            begin
                pword := composite_header_ptr;
                num_instr := TTF_Helpers.SwapUInt16( pword^ );
                composite_header_ptr := TTF_Helpers.Increment(composite_header_ptr, (2 + num_instr))
            end
        end;
