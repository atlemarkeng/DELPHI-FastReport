...
uses
  ...
  FMX.Types, System.UIConsts, System.Types,
  FMX.fs_iinterpreter, FMX.frxClass, FMX.frxCtrls,
  FMX.frxPreviewPages, FMX.frxEngine, FMX.frxDMPClass, FMX.frxVariables, FMX.fs_iformsrtti,
  FMX.frxUnicodeUtils, FMX.frxFMX
{$IFDEF DELPHI18}
  ,FMX.Controls
{$ENDIF};
...
begin
  ...
  begin
    ...
    AddConst('clTransparent', 'Integer', claNull);
    ...
    begin
      ...
      AddMethod('procedure SetBounds(ALeft, ATop, AWidth, AHeight: Double)', CallMethod);
      ...
      AddProperty('AbsLeft', 'Double', GetProp, nil);
      AddProperty('AbsTop', 'Double', GetProp, nil);
    end;
    ...
    begin
      ...
      AddMethod('function FreeSpace: Double', CallMethod);
...
begin
  ...
  begin
    ...
    if MethodName = 'CREATE' then
      ...
      _TStrings.LoadFromFile(Caller.Params[0], TEncoding.Unicode)
  ...
  begin
    if MethodName = 'SETFOCUS' then
      if TfrxDialogControl(Instance).Control is TControl then
        TControl(TfrxDialogControl(Instance).Control).SetFocus;
  end
