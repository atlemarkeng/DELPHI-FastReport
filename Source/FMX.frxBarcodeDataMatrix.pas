...
//      - выделение базового класса frxBarcodeBase, чтобы разные бары наследовались  ????????
//
//


unit FMX.frxBarcodeDataMatrix;
...
uses System.SysUtils, System.Types, System.UITypes, System.StrUtils,
      System.Classes, FMX.Objects, FMX.Types, FMX.Controls, FMX.Forms,
      FMX.Dialogs, FMX.frxBarcode2DBase
{$IFDEF DELPHI19}
  , FMX.Graphics
{$ENDIF};
...
TfrxBarcodeDataMatrix = class( TfrxBarcode2DBase )
  ...
  private
    ...
    procedure Generate( var text :TBytes; textOffset, textSize : integer); overload;
    function  GetEncodation(var Text : tbytes; textOffset, textSize : integer; var data : Tbytes;
                                     dataOffset, dataSize : integer; firstMatch : boolean) : integer;

    procedure Draw(var data : TBytes; dataSize : integer; const dm: DmParams);
...
procedure GenerateECC(var wd : TBytes; nd, datablock, nc : integer );
...
function TfrxBarcodeDataMatrix.GetPixelSize : integer; begin result := FPixelWidth; end;
procedure TfrxBarcodeDataMatrix.SetPixelSize(v : integer); begin FPixelWidth := v; FPixelHeight := v; end;
...
procedure TfrxBarcodeDataMatrix.Draw(var data : tbytes; dataSize : integer; const dm: DmParams);
var
...
procedure MakePadding(var data : tbytes; position, count : integer);
var
    t : integer;
begin
...
begin
    result := false;
    if ansichar(c) in ['0'..'9'] then result := true;
end;


function AsciiEncodation( var text : tbytes; textOffset, textLength : integer; var data : tbytes; dataOffset, dataLength : integer )  : integer;
var
...
function B256Encodation(var text : tbytes; textOffset, textLength : integer; var data : tbytes; dataOffset, dataLength : integer ) : integer;
var
...
function X12Encodation(var text: tbytes; textOffset, textLength : integer; var data : tbytes; dataOffset, dataLength : integer ) : integer;
var
...
function EdifactEncodation(var text: tbytes; textOffset, textLength: integer; var data: tbytes; dataOffset, dataLength: integer): integer;
var
...
function C40OrTextEncodation(var Text : tbytes; textOffset, textLength : integer; var data : tbytes; dataOffset, dataLength : integer;
                             C40 : boolean ) : integer;
var
...
function TfrxBarcodeDataMatrix.GetEncodation(var Text : tbytes; textOffset, textSize : integer; var data : tbytes;
                                     dataOffset, dataSize : integer; firstMatch : boolean) : integer;
var
      e, j, k : integer;
...
begin
    ...
    result := ReplaceStr(text, '&1;', string(#29));
end;
...
begin
  ...
  procedure TfrxBarcodeDataMatrix.Generate(var text: TBytes; textOffset, textSize : integer);
...
procedure ReedSolomonBlock(var wd : TBytes; nd : integer; var ncout : TBytes; nc: integer; var c : TInts );
var
