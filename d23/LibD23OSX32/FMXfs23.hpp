...
// (DO NOT EDIT: machine generated header) 'FMXfs23.dpk' rev: 30.00 (MacOS)
...
#include <SysInit.hpp>
#include <FMX.fs_ipascal.hpp>
#include <FMX.fs_icpp.hpp>
#include <FMX.fs_ijs.hpp>
#include <FMX.fs_ibasic.hpp>
#include <FMX.fs_iclassesrtti.hpp>
#include <FMX.fs_iconst.hpp>
#include <FMX.fs_idialogsrtti.hpp>
#include <FMX.fs_ievents.hpp>
#include <FMX.fs_iexpression.hpp>
#include <FMX.fs_iextctrlsrtti.hpp>
#include <FMX.fs_iformsrtti.hpp>
#include <FMX.fs_igraphicsrtti.hpp>
#include <FMX.fs_iilparser.hpp>
#include <FMX.fs_iinirtti.hpp>
#include <FMX.fs_iinterpreter.hpp>
#include <FMX.fs_iparser.hpp>
#include <FMX.fs_isysrtti.hpp>
#include <FMX.fs_imenusrtti.hpp>
#include <FMX.fs_itools.hpp>
#include <FMX.fs_xml.hpp>
#include <FMX.fs_synmemo.hpp>
#include <FMX.fs_tree.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFS23)
using namespace Fmxfs23;
#endif
#pragma pack(pop)
#pragma option pop
