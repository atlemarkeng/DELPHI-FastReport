...
// (DO NOT EDIT: machine generated header) 'FMXfrxCDS23.dpk' rev: 30.00 (MacOS)

#ifndef Fmxfrxcds23HPP
#define Fmxfrxcds23HPP
...
#include <SysInit.hpp>
#include <FMX.frxCDSComponents.hpp>
#include <FMX.frxCDSEditor.hpp>
#include <FMX.frxCDSRTTI.hpp>
...
namespace Fmxfrxcds23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfrxcds23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFRXCDS23)
using namespace Fmxfrxcds23;
#endif
#pragma pack(pop)
#pragma option pop
