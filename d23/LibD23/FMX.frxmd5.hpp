...
// (DO NOT EDIT: machine generated header) 'FMX.frxmd5.pas' rev: 30.00 (Windows)

#ifndef Fmx_Frxmd5HPP
#define Fmx_Frxmd5HPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FRXMD5)
using namespace Fmx::Frxmd5;
#endif
