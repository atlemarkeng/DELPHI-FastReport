...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxCDS23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxcds23HPP
#define Dclfmxfrxcds23HPP
...
#include <FMX.frxCDSRTTI.hpp>	// (FMXfrxCDS23)
#include <FMX.frxCDSEditor.hpp>	// (FMXfrxCDS23)
#include <FMX.frxCDSComponents.hpp>	// (FMXfrxCDS23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrxcds23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxcds23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXCDS23)
using namespace Dclfmxfrxcds23;
#endif
#pragma pack(pop)
#pragma option pop
