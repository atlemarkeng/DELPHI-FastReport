...
// (DO NOT EDIT: machine generated header) 'FMXfrxDB23.dpk' rev: 30.00 (Windows)

#ifndef Fmxfrxdb23HPP
#define Fmxfrxdb23HPP
...
namespace Fmxfrxdb23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfrxdb23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFRXDB23)
using namespace Fmxfrxdb23;
#endif
#pragma pack(pop)
#pragma option pop
