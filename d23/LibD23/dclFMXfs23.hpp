...
// (DO NOT EDIT: machine generated header) 'dclFMXfs23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfs23HPP
#define Dclfmxfs23HPP
...
#include <FMX.fs_iextctrlsrtti.hpp>	// (FMXfs23)
#include <FMX.fs_idialogsrtti.hpp>	// (FMXfs23)
#include <FMX.fs_iinirtti.hpp>	// (FMXfs23)
#include <FMX.fs_imenusrtti.hpp>	// (FMXfs23)
...
#include <FMX.fs_tree.hpp>	// (FMXfs23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfs23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfs23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFS23)
using namespace Dclfmxfs23;
#endif
#pragma pack(pop)
#pragma option pop
