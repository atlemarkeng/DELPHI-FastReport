...
// (DO NOT EDIT: machine generated header) 'dclFMXfrx23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrx23HPP
#define Dclfmxfrx23HPP
...
#include <FMX.frxDesgnCtrls.hpp>	// (FMXfrx23)
#include <FMX.frxrcInsp.hpp>	// (FMXfrx23)
#include <FMX.frxDataTree.hpp>	// (FMXfrx23)
...
#include <FMX.frxDesgnEditors.hpp>	// (FMXfrx23)
#include <FMX.frxrcDesgn.hpp>	// (FMXfrx23)
#include <FMX.frxDesgn.hpp>	// (FMXfrx23)
#include <FMX.Grid.hpp>	// (fmx)
#include <FMX.frxDCtrlRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxDCtrl.hpp>	// (FMXfrx23)
#include <FMX.frxCrossEditor.hpp>	// (FMXfrx23)
#include <FMX.frxCrossRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxCross.hpp>	// (FMXfrx23)
#include <FMX.frxBarcode2DRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxBarcode2DView.hpp>	// (FMXfrx23)
#include <FMX.frxBarcod.hpp>	// (FMXfrx23)
#include <FMX.frxBarcodeEditor.hpp>	// (FMXfrx23)
#include <FMX.frxBarcodeRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxBarcode.hpp>	// (FMXfrx23)
#include <FMX.frxChBoxRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxChBox.hpp>	// (FMXfrx23)
#include <FMX.frxGradientRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxGradient.hpp>	// (FMXfrx23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrx23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrx23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRX23)
using namespace Dclfmxfrx23;
#endif
#pragma pack(pop)
#pragma option pop
