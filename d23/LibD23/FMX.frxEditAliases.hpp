...
// (DO NOT EDIT: machine generated header) 'FMX.frxEditAliases.pas' rev: 30.00 (Windows)
...
public:
	/* TStringGrid.Create */ inline __fastcall virtual THackStringGrid(System::Classes::TComponent* AOwner)/* overload */ : Fmx::Grid::TStringGrid(AOwner) { }
	/* TStringGrid.Destroy */ inline __fastcall virtual ~THackStringGrid(void) { }
...
protected:
	virtual void __fastcall UpdateRowCount(const int RowCount);
	virtual System::Rtti::TValue __fastcall GetCells(int ARow);
	virtual void __fastcall SetCells(int ARow, const System::Rtti::TValue &Value);
public:
	/* TCheckColumn.Create */ inline __fastcall virtual TStringCheckColumn(System::Classes::TComponent* AOwner)/* overload */ : Fmx::Grid::TCheckColumn(AOwner) { }
	/* TCheckColumn.Destroy */ inline __fastcall virtual ~TStringCheckColumn(void) { }
