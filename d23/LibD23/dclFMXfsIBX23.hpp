...
// (DO NOT EDIT: machine generated header) 'dclFMXfsIBX23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfsibx23HPP
#define Dclfmxfsibx23HPP
...
#include <FMX.fs_iibxrtti.hpp>	// (FMXfsIBX23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfsibx23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfsibx23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFSIBX23)
using namespace Dclfmxfsibx23;
#endif
#pragma pack(pop)
#pragma option pop
