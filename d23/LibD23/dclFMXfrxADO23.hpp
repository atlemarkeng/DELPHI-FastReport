...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxADO23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxado23HPP
#define Dclfmxfrxado23HPP
...
#include <FMX.frxADORTTI.hpp>	// (FMXfrxADO23)
#include <FMX.frxADOEditor.hpp>	// (FMXfrxADO23)
#include <FMX.frxADOComponents.hpp>	// (FMXfrxADO23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrxado23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxado23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXADO23)
using namespace Dclfmxfrxado23;
#endif
#pragma pack(pop)
#pragma option pop
