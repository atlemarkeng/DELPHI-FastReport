...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxIBX23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxibx23HPP
#define Dclfmxfrxibx23HPP
...
#include <FMX.frxIBXRTTI.hpp>	// (FMXfrxIBX23)
#include <FMX.frxIBXEditor.hpp>	// (FMXfrxIBX23)
#include <FMX.frxIBXComponents.hpp>	// (FMXfrxIBX23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrxibx23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxibx23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXIBX23)
using namespace Dclfmxfrxibx23;
#endif
#pragma pack(pop)
#pragma option pop
