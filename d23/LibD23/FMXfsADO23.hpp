...
// (DO NOT EDIT: machine generated header) 'FMXfsADO23.dpk' rev: 30.00 (Windows)

#ifndef Fmxfsado23HPP
#define Fmxfsado23HPP
...
namespace Fmxfsado23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfsado23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSADO23)
using namespace Fmxfsado23;
#endif
#pragma pack(pop)
#pragma option pop
