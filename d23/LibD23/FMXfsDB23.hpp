...
// (DO NOT EDIT: machine generated header) 'FMXfsDB23.dpk' rev: 30.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSDB23)
using namespace Fmxfsdb23;
#endif
#pragma pack(pop)
#pragma option pop
