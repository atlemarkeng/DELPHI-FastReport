...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxTee23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxtee23HPP
#define Dclfmxfrxtee23HPP
...
#include <FMX.frxChartHelpers.hpp>	// (FMXfrxTee23)
#include <FMX.fs_ichartrtti.hpp>	// (FMXfsTee23)
#include <FMX.frxChartRTTI.hpp>	// (FMXfrxTee23)
...
#include <FMX.frxChartEditor.hpp>	// (FMXfrxTee23)
#include <FMX.frxChart.hpp>	// (FMXfrxTee23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrxtee23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxtee23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXTEE23)
using namespace Dclfmxfrxtee23;
#endif
#pragma pack(pop)
#pragma option pop
