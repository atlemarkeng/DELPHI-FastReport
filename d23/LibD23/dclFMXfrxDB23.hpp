...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxDB23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxdb23HPP
#define Dclfmxfrxdb23HPP
...
namespace Dclfmxfrxdb23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxdb23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXDB23)
using namespace Dclfmxfrxdb23;
#endif
#pragma pack(pop)
#pragma option pop
