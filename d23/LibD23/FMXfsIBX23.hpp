...
// (DO NOT EDIT: machine generated header) 'FMXfsIBX23.dpk' rev: 30.00 (Windows)

#ifndef Fmxfsibx23HPP
#define Fmxfsibx23HPP
...
namespace Fmxfsibx23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfsibx23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSIBX23)
using namespace Fmxfsibx23;
#endif
#pragma pack(pop)
#pragma option pop
