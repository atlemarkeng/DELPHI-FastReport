...
// (DO NOT EDIT: machine generated header) 'dclFMXfsADO23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfsado23HPP
#define Dclfmxfsado23HPP
...
namespace Dclfmxfsado23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfsado23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFSADO23)
using namespace Dclfmxfsado23;
#endif
#pragma pack(pop)
#pragma option pop
