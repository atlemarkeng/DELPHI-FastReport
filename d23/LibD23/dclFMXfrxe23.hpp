...
// (DO NOT EDIT: machine generated header) 'dclFMXfrxe23.dpk' rev: 30.00 (Windows)

#ifndef Dclfmxfrxe23HPP
#define Dclfmxfrxe23HPP
...
#include <FMX.frxrcExports.hpp>	// (FMXfrxe23)
#include <FMX.frxExportHTML.hpp>	// (FMXfrxe23)
#include <FMX.TabControl.hpp>	// (fmx)
#include <FMX.frxChBoxRTTI.hpp>	// (FMXfrx23)
#include <FMX.frxChBox.hpp>	// (FMXfrx23)
#include <FMX.frxTrueTypeCollection.hpp>	// (FMXfrxe23)
#include <FMX.frxCrypto.hpp>	// (FMXfrxe23)
#include <FMX.frxExportPDF.hpp>	// (FMXfrxe23)

//-- user supplied -----------------------------------------------------------

namespace Dclfmxfrxe23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfmxfrxe23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFMXFRXE23)
using namespace Dclfmxfrxe23;
#endif
#pragma pack(pop)
#pragma option pop
