...
begin
  ...
  TPrinterMac(FMX.Printer.Printer).PrintInfo.setOrientation(Orientation);
...
begin
  ...
  FLeftMargin :=  TPrinterMac(FMX.Printer.Printer).PrintInfo.leftMargin/ FDPI.X * 4;
  FTopMargin := TPrinterMac(FMX.Printer.Printer).PrintInfo.topMargin/ FDPI.Y * 4;
  FBottomMargin := FPaperHeight - TPrinterMac(FMX.Printer.Printer).PrintInfo.bottomMargin/ FDPI.X * 4;
  FRightMargin := FPaperWidth - TPrinterMac(FMX.Printer.Printer).PrintInfo.rightMargin/ FDPI.X * 4;
