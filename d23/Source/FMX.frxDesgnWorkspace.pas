  ...
  begin
    ...
    begin
      ...
      if Self.Width > Self.Height then
        maxi := Self.FPageWidth else
        maxi := Self.FPageHeight;
      ...
      begin
        ...
        begin
          Line(Round(i) + 0.5, 0, Round(i) + 0.5, Round(Self.FPageHeight));
          Line(0, Round(i) + 0.5, Round(Self.Width), Round(i) + 0.5);
        end;
        i := i + dx;
        Inc(i1);
      end;
