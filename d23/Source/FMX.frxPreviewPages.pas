...
uses
  ...
  FMX.frxClass, FMX.frxXML, FMX.frxPictureCache
{$IFDEF DELPHI19}
  , FMX.Graphics
{$ENDIF}
{$IFDEF DELPHI19}
...
uses
  FMX.frxPreview, FMX.frxPrinter, FMX.frxXMLSerializer,
  FMX.frxUtils, FMX.frxDMPClass, FMX.frxRes, FMX.frxFMX, FMX.frxPrintDialog, FMX.Dialogs
{$IFDEF MSWINDOWS}
 , Winapi.ShellAPI
{$ENDIF}
{$IFDEF MACOS}
...
begin
  ...
  begin
    DrawPageInternal(Index, Canvas, ScaleX, ScaleY, OffsetX, OffsetY);
    Exit;
  end;
  ...
  begin
    ...
    Bitmap := TBitmap.Create(Round(Page.Width * ScaleX), Round(Page.Height * ScaleY));
