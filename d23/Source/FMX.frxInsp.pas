...
var
  ...
  begin
    ...
    begin
      ...
      FillText(RectF(x, y, FSplitterPos - 1, y + FRowHeight), s, False, 1, [], TTextAlign.taLeading, TTextAlign.taLeading);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      if paOwnerDraw in p.Editor.GetAttributes then
        ...
        FillText(RectF(FSplitterPos + 2, 1 + i * FRowHeight, PB.Width + 2, 1 + i * FRowHeight + FRowHeight), GetValue(i), False, 1, [], TTextAlign.taLeading, TTextAlign.taLeading);
    end;
  end;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        wItem := Round(Self.Canvas.TextWidth(Items[i]));
