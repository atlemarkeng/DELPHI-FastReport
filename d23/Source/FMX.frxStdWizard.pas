...
begin
  ...
  s := TStringStream.Create(StyleReport, TEncoding.UTF8);
  ...
  begin
    s := TStringStream.Create(Style, TEncoding.UTF8);
...
begin
  if TabularRB.Checked then
    s := TStringStream.Create(LayoutTabularReport, TEncoding.UTF8)
  else
    s := TStringStream.Create(LayoutColumnarReport, TEncoding.UTF8);
