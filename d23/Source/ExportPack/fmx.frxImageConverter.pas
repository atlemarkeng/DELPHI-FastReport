...
begin
  ...
  try
    case PicType of
      ...
      gpJPG: Filter.SaveToStream(Stream, Graphic, 'jpeg');
...
begin
    case PicType of
      ...
      gpJPG: TBitmapCodecManager.SaveToStream(Stream, Graphic, 'jpeg');
...
begin
  ...
  try
    ...
    case PicType of
      ...
      gpJPG: TBitmapCodecManager.SaveToStream(Stream, Surf, 'jpeg');
