...
// (DO NOT EDIT: machine generated header) 'FMX.frxDsgnIntf.pas' rev: 30.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, TfrxPropertyEditorClass);
...
_DECLARE_METACLASS(System::TMetaClass, TfrxComponentEditorClass);
