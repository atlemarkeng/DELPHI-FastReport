...
// (DO NOT EDIT: machine generated header) 'FMX.frxCrypto.pas' rev: 30.00 (Windows)

#ifndef Fmx_FrxcryptoHPP
#define Fmx_FrxcryptoHPP
...
protected:
	...
	void __fastcall ExpandKey(System::Byte const *Key, const int Key_High);
	virtual void __fastcall Encrypt(TCryptoAESMatrix &a)/* overload */;
	virtual void __fastcall Decrypt(TCryptoAESMatrix &a)/* overload */;
	
public:
	__fastcall TCryptoAES(System::Byte const *Key, const int Key_High);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECryptoAESException(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESException(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECryptoAESException(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESException(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECryptoAESInvalidKeyLength(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : ECryptoAESException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESInvalidKeyLength(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoAESException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESInvalidKeyLength(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoAESException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECryptoAESInvalidKeyLength(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : ECryptoAESException(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESInvalidKeyLength(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoAESException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESInvalidKeyLength(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoAESException(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECryptoAESInvalidBlockSize(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : ECryptoAESException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESInvalidBlockSize(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoAESException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECryptoAESInvalidBlockSize(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoAESException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECryptoAESInvalidBlockSize(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : ECryptoAESException(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESInvalidBlockSize(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoAESException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoAESInvalidBlockSize(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoAESException(Ident, Args, Args_High, AHelpContext) { }
...
public:
	__fastcall TCryptoAES_CBC(System::Byte const *Key, const int Key_High, const void *IV);
public:
...
protected:
	...
	virtual void __fastcall Process(System::Byte const *Chunk, const int Chunk_High) = 0 ;
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECryptoHash(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECryptoHash(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECryptoHash(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECryptoHash(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoHash(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoHash(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall ECryptoHashUnknown(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : ECryptoHash(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECryptoHashUnknown(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoHash(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECryptoHashUnknown(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : ECryptoHash(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECryptoHashUnknown(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : ECryptoHash(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoHashUnknown(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoHash(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECryptoHashUnknown(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : ECryptoHash(Ident, Args, Args_High, AHelpContext) { }
...
protected:
	virtual void __fastcall Process(System::Byte const *Chunk, const int Chunk_High);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FRXCRYPTO)
using namespace Fmx::Frxcrypto;
#endif
