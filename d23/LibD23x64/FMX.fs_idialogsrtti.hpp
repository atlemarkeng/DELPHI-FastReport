...
// (DO NOT EDIT: machine generated header) 'FMX.fs_idialogsrtti.pas' rev: 30.00 (Windows)

#ifndef Fmx_Fs_idialogsrttiHPP
#define Fmx_Fs_idialogsrttiHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_FS_IDIALOGSRTTI)
using namespace Fmx::Fs_idialogsrtti;
#endif
