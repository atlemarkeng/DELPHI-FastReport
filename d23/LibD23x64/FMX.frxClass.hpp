...
// (DO NOT EDIT: machine generated header) 'FMX.frxClass.pas' rev: 30.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDuplicateName(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateName(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDuplicateName(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDuplicateName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDuplicateName(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
_DECLARE_METACLASS(System::TMetaClass, TfrxComponentClass);
...
private:
	...
	bool FWordWrap;
	bool FWysiwyg;
	Fmx::Graphics::TBitmap* FBmpCanvas;
...
_DECLARE_METACLASS(System::TMetaClass, TfrxBandClass);
...
class PASCALIMPLEMENTATION TfrxCustomDesigner : public Fmx::Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxCustomDesigner(System::Classes::TComponent* AOwner) : Fmx::Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxCustomDesigner(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Forms::TForm(AOwner, Dummy) { }
	
};


_DECLARE_METACLASS(System::TMetaClass, TfrxDesignerClass);
...
_DECLARE_METACLASS(System::TMetaClass, TfrxWizardClass);
...
public:
	...
	virtual void __fastcall DrawPage(int Index, Fmx::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, System::Extended OffsetX, System::Extended OffsetY) = 0 ;
...
_DECLARE_METACLASS(System::TMetaClass, TfrxCompressorClass);
...
_DECLARE_METACLASS(System::TMetaClass, TfrxCrypterClass);
