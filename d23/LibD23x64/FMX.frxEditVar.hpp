...
// (DO NOT EDIT: machine generated header) 'FMX.frxEditVar.pas' rev: 30.00 (Windows)
...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TfrxVarEditorForm : public Fmx::Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxVarEditorForm(System::Classes::TComponent* AOwner) : Fmx::Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrxVarEditorForm(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Forms::TForm(AOwner, Dummy) { }
