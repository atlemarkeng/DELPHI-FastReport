...
// (DO NOT EDIT: machine generated header) 'FMX.frxBarcodeDataMatrix.pas' rev: 30.00 (Windows)
...
private:
	...
	void __fastcall Generate(System::TArray__1<System::Byte> &text, int textOffset, int textSize)/* overload */;
	int __fastcall GetEncodation(System::TArray__1<System::Byte> &Text, int textOffset, int textSize, System::TArray__1<System::Byte> &data, int dataOffset, int dataSize, bool firstMatch);
	void __fastcall Draw(System::TArray__1<System::Byte> &data, int dataSize, const DmParams &dm);
...
extern DELPHI_PACKAGE void __fastcall GenerateECC(System::TArray__1<System::Byte> &wd, int nd, int datablock, int nc);
}	/* namespace Frxbarcodedatamatrix */
}	/* namespace Fmx */
