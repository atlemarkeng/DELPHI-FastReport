...
// (DO NOT EDIT: machine generated header) 'FMX.fs_synmemo.pas' rev: 30.00 (Windows)
...
private:
	...
	Fmx::Graphics::TBrush* FGutterFill;
	...
	Fmx::Graphics::TBitmap* FTmpCanvas;
	...
	TCharAttributes __fastcall GetCharAttr(System::Types::TPoint Pos);
	int __fastcall GetLineBegin(int Index);
	int __fastcall GetPlainTextPos(System::Types::TPoint Pos);
	...
	void __fastcall SetGutterFill(Fmx::Graphics::TBrush* const Value);
...
protected:
	...
	void __fastcall DOver(System::TObject* Sender, const Fmx::Types::TDragObject &Data, const System::Types::TPointF Point, Fmx::Types::TDragOperation &Operation);
	...
	void __fastcall SetAttr(Fmx::Graphics::TCanvas* aCanvas, TCharAttributes a);
	
public:
	__fastcall virtual TfsSyntaxMemo(System::Classes::TComponent* AOwner)/* overload */;
...
__published:
	...
	__property Fmx::Graphics::TBrush* GutterFill = {read=FGutterFill, write=SetGutterFill};
...
public:
	...
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfsSynMemoSearch(System::Classes::TComponent* AOwner, NativeInt Dummy) : Fmx::Forms::TForm(AOwner, Dummy) { }
