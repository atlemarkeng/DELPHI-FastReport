...
// (DO NOT EDIT: machine generated header) 'FMXfsTee23.dpk' rev: 30.00 (Windows)

#ifndef Fmxfstee23HPP
#define Fmxfstee23HPP
...
namespace Fmxfstee23
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Fmxfstee23 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMXFSTEE23)
using namespace Fmxfstee23;
#endif
#pragma pack(pop)
#pragma option pop
